  ...
  useEffect(() => {
    ...
    button?.addEventListener("click", () => {
      ...
      if (isToggle) {
        ...
        segmentUpper.draw("69.5%", "100%", 0.5);
        segmentLower.draw("69.5%", "100%", 0.5);
        segmentMid.draw("0", "0", 0.5);
      } else {
        aside?.classList.remove("sidebar-show");
        segmentUpper.draw("0", "28.5%", 0.5);
        segmentLower.draw("0", "28.5%", 0.5);
        segmentMid.draw("0%", "100%", 0.5);
      }
    });
          ...
          <div className="nav-header">
            ...
            <div className="nav-btn">
              <svg version="1.1" viewBox="0 0 42.996 49.124">
                <g
                  transform="translate(-90.622 -136.32)"
                  fill="none"
                  stroke="#000"
                  strokeLinecap="round"
                  strokeWidth="0.8"
